<x-app-layout>
  ...
  <form action="{{ route('tasks.store') }}" method="POST">
    ...
    <div class="mb-4">
      ...
      <input type="text" name="name" id="name" class="w-full bg-gray-100 border border-gray-300 rounded px-4 py-2" value="{{ old('name') }}">
    </div>
    <div class="mb-4">
      <label for="description" class="block font-bold">Description:</label>
      <textarea name="description" id="description" class="w-full bg-gray-100 border border-gray-300 rounded px-4 py-2">{{ old('description') }}</textarea>
    </div>
    <div class="mb-4">
      <label for="status" class="block font-bold">Status:</label>
      <select name="status" id="status" class="w-full bg-gray-100 border border-gray-300 rounded px-4 py-2">
    ...
    <div class="mb-4">
      ...
      <input type="text" name="deadline" id="deadline" class="w-full bg-gray-100 border border-gray-300 rounded px-4 py-2" value="{{ old('deadline') }}">
    </div>
    <div class="mb-4">
      <label for="priority" class="block font-bold">Priority:</label>
      <select name="priority" id="priority" class="w-full bg-gray-100 border border-gray-300 rounded px-4 py-2">
